            ...
            <div className='maincontainer'>
                ...
                <div className='mobileconntainer' id='mobilecontainer'>
                    <div className='addinputs' id="addinputs">
                        ...
                        <input type="text" placeholder='price' defaultValue={price} disabled />
                        <input type="text" placeholder='Quantity' defaultValue={quantity} onChange={(e) => { setquantity(e.target.value) }} />
                        <input type="text" placeholder='Total price' defaultValue={price*quantity} onChange={(e) => { settotal(e.target.value) }} disabled/>
